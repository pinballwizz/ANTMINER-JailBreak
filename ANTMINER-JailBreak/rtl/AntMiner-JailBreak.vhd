...
end jailbreak_antminer;
------------------------------------------------------------------------------
architecture struct of jailbreak_antminer is
 ...
 signal p1_buttons  : std_logic_vector(1 downto 0);
...
p1_buttons  <= not joy_BBBBFRLDU(8) & not joy_BBBBFRLDU(4);
p2_buttons  <= not joy_BBBBFRLDU(8) & not joy_BBBBFRLDU(4); 
---------------------------------------------------------------------------
-- Main

jailbreak : entity work.Jailbreak
  port map (
 clk_49m        => clock_48,
...
-- vga output
	...
	O_VIDEO_R 	<= video_r(3 downto 1); --video_r_x2(5 downto 3);
	O_VIDEO_G 	<= video_g(3 downto 1); -- video_g_x2(5 downto 3);
	O_VIDEO_B 	<= video_b(3 downto 2); -- video_b_x2(5 downto 4);
	O_HSYNC     <= M_HSYNC; -- hsync_x2;
	O_VSYNC     <= M_VSYNC; -- vsync_x2;
---------------------------------------------------------------
 -- Audio DAC
